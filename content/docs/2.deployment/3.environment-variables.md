...
| Variable | Type | Default | Description |
|----------|------|---------|-------------|
| `GOOGLE_CLIENT_ID` | `string` | *(empty)* | Google OAuth 2.0 Client ID for Google Calendar integration. See [Google Calendar Integration](/docs/features/google-calendar) for setup instructions. |
